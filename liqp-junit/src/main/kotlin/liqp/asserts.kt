...
fun assertFileTemplate(
    templateFile: File, data: Any? = null,
    renderer: RenderConfigurer = { this },
    parser: ParseConfigurer = { this }
): TemplateRenderAssert {
...
@JvmOverloads
fun createTestRenderer(block: MutableRenderSettings.() -> Unit = {}): LRenderer {
...
@JvmOverloads
fun createTestParser(block: MutableParseSettings.() -> Unit = {}): LParser {
