...
class StripFilterHtmlFilterTestParameterized(val template: String, val expected: String) {
...
@RunWith(Parameterized::class)
class StripFilterHtmlFilterTest(val name: String, val template: String?, val expected: String?) {
