...
public abstract class LValue {
   ...
   *
   * @return true iff a and b are equals, where (int) 1 is equals to (double) 1.0
   */
  ...
  /**
   * Returns this value as an array. If a value is already an array, it is casted to a `Object[]`, if it's a
   * `java.util.List`, it is converted to an array and in all other cases, `value` is simply returned as an `Object[]`
   ...
   * @throws NumberFormatException when `value` is a String which could not be parsed as a Long or Double.
   */
  public static Number asNumber(Object value) throws NumberFormatException {
  ...
  public static boolean canBeInteger(Object value) {
    return String.valueOf(value).matches("-?\\d+");
  }

  public static boolean canBeDouble(Object value) {
