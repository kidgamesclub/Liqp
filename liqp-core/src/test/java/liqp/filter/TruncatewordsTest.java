...
public class TruncatewordsTest {
  ...
  public void applyOriginalTest() {
    ...
    final LFilter filter = LiquidDefaults.getDefaultFilters().getFilter("truncatewords");

    assertThat(filter.doPostFilter(mockRenderContext(), "one two three", 4), is((Object) "one two three"));
    assertThat(filter.doPostFilter(mockRenderContext(), "one two three", 2), is((Object) "one two..."));
    assertThat(filter.doPostFilter(mockRenderContext(), "one two three", 3), is((Object) "one two three"));
    assertThat(filter.doPostFilter(mockRenderContext(), "Two small (13&#8221; x 5.5&#8221; x 10&#8221; high) baskets fit " +
                "inside one large basket (13&#8221; x 16&#8221; x 10.5&#8221; high) with cover.", 15),
          is((Object) "Two small (13&#8221; x 5.5&#8221; x 10&#8221; high) baskets fit inside one large basket " +
                "(13&#8221;..."));
  }
}
