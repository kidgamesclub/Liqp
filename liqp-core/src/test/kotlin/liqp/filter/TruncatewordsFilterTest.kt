...
class TruncatewordsFilterTests(template: String, result: String) : LiquifyNoInputTest(template, result, "{ \"txt\" : \"a        b c d e f g h i j a b c d e f g h i j\" }") {
...
class TruncatewordsFilterTest {
  @Test
  fun testTruncatedBounds() {
    TruncatewordsFilter().assertThat()
